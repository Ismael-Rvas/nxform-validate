...
const schema = z.object({
    ...
    edad: z.coerce.number()
        ...
        .max(50, "La edad máxima debe ser 50 años"),
    telefono: z.string().trim()
        .regex(/[678]{1}[0-9]{8}/, "Escribe 9 dígitos, siendo el primero 6,7 u 8"),
    email: z.string().email({ message: "Email no válido" }),
    fecha: z.coerce.date()
        .min(new Date("2023-01-01"), "La fecha debe ser posterior o igual al 1 de enero de 2023")
        .max(new Date("2025-01-13"), "La fecha debe ser anterior o igual al 13 de enero de 2025"),
